...
+ clustrix compatible 
+ geo_point support, using custom rules:
```
[rule.field]
...
+ `go get github.com/jrots/go-mysql-elasticsearch`, it will print some messages in console, skip it. :-)
+ cd `$GOPATH/src/github.com/jrots/go-mysql-elasticsearch`
+ `make`
